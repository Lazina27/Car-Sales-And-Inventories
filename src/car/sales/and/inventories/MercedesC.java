...
public class MercedesC extends javax.swing.JFrame {
 Connection conn=null;
    ...
    public void showMercedesC(){
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.CCLASS");
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.ECLASS");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.GLECLASS");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.SCLASS");
        ResultSet res=stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton77, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 120, 40));

        jLabel73.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel73.setForeground(new java.awt.Color(102, 0, 0));
        jLabel73.setText("  Mercedes-Benz GLE-class");
        jLabel73.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 0, 0), 3));
        getContentPane().add(jLabel73, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 460, 270, 40));
        ...
        getContentPane().add(jLabel78, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 550, -1, -1));
        ...
        getContentPane().add(jTextField58, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 540, 170, 40));
        ...
        getContentPane().add(jButton83, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 540, 120, 40));
        ...
        getContentPane().add(jLabel79, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 610, -1, -1));
        ...
        getContentPane().add(jTextField59, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 600, 170, 40));
        ...
        getContentPane().add(jLabel80, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 670, -1, -1));
        getContentPane().add(jTextField60, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 660, 170, 40));
        ...
        getContentPane().add(jButton85, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 600, 120, 40));

        jLabel77.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel77.setForeground(new java.awt.Color(102, 0, 0));
        jLabel77.setText("  Mercedes-Benz S-class");
        jLabel77.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 0, 0), 3));
        getContentPane().add(jLabel77, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 460, 260, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 40, -1, 50));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 770, 380, 100));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, 380, 100));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 320, 380, 100));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 770, 380, 100));

        jButton78.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton78.setForeground(new java.awt.Color(102, 0, 0));
        ...
        getContentPane().add(jButton78, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 160, 120, 40));
    ...
    private void jButton71ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton71ActionPerformed
        ...
        try{
           ...
           String sql="insert into CARSALE.CCLASS(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
    ...
    private void jButton77ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton77ActionPerformed
        ...
        try{
           ...
           String Stock=jTextField50.getText();
           String Sold=jTextField51.getText();
           String sql="delete from CARSALE.CCLASS where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
    ...
    private void jButton75ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton75ActionPerformed
        ...
        try{
          ...
          String Purchased=jTextField52.getText();
           ...
           String sql="insert into CARSALE.ECLASS(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton78ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton78ActionPerformed
        ...
        try{
          ...
          String Purchased=jTextField52.getText();
           String Stock=jTextField53.getText();
           String Sold=jTextField54.getText();
           String sql="delete from CARSALE.ECLASS where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField52.setText("");
    ...
    private void jButton79ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton79ActionPerformed
        ...
        try{
          ...
          String Purchased=jTextField55.getText();
           ...
           String sql="insert into CARSALE.GLECLASS(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton81ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton81ActionPerformed
        ...
        try{
          ...
          String Purchased=jTextField55.getText();
           String Stock=jTextField56.getText();
           String Sold=jTextField57.getText();
           String sql="delete from CARSALE.GLECLASS where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField55.setText("");
    ...
    private void jButton83ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton83ActionPerformed
        ...
        try{
          ...
          String Purchased=jTextField58.getText();
           ...
           String sql="insert into CARSALE.SCLASS(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton85ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton85ActionPerformed
         ...
         String Purchased=jTextField58.getText();
           String Stock=jTextField59.getText();
           String Sold=jTextField60.getText();
           String sql="delete from CARSALE.SCLASS where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField58.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MercedesC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
