 ...
 * @author Lenovo
 */
public class BMWC extends javax.swing.JFrame {
    ...
    public void showBMWC(){
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.S5");
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.S7");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.X5");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.X6");
        ResultSet res=stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton73, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 170, 120, 40));
        ...
        getContentPane().add(jButton77, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 170, 120, 40));

        jLabel73.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel73.setForeground(new java.awt.Color(102, 0, 0));
        jLabel73.setText("     BMW X5");
        jLabel73.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 0, 0), 3));
        getContentPane().add(jLabel73, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 460, 140, 40));
        ...
        jLabel77.setText("     BMW X6");
        jLabel77.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 0, 0), 3));
        getContentPane().add(jLabel77, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 460, 130, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 40, -1, 40));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 380, 100));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 290, 380, 100));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 710, 380, 100));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 710, 380, 100));
    ...
    private void jButton71ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton71ActionPerformed
       try{
           ...
           String sql="insert into CARSALE.S5(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
    ...
    private void jButton73ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton73ActionPerformed
        try{
           ...
           String Stock=jTextField50.getText();
           String Sold=jTextField51.getText();
           String sql="delete from CARSALE.S5 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
    ...
    private void jButton75ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton75ActionPerformed
        try{
          ...
          String Purchased=jTextField52.getText();
           ...
           String sql="insert into CARSALE.S7(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton77ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton77ActionPerformed
        try{
          ...
          String Purchased=jTextField52.getText();
           String Stock=jTextField53.getText();
           String Sold=jTextField54.getText();
           String sql="delete from CARSALE.S7 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField52.setText("");
    ...
    private void jButton79ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton79ActionPerformed
        try{
          ...
          String Purchased=jTextField55.getText();
           ...
           String sql="insert into CARSALE.X5(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton81ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton81ActionPerformed
        try{
          ...
          String Purchased=jTextField55.getText();
           String Stock=jTextField56.getText();
           String Sold=jTextField57.getText();
           String sql="delete from CARSALE.X5 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField55.setText("");
    ...
    private void jButton83ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton83ActionPerformed
        try{
          ...
          String Purchased=jTextField58.getText();
           ...
           String sql="insert into CARSALE.X6(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton85ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton85ActionPerformed
         ...
         String Purchased=jTextField58.getText();
           String Stock=jTextField59.getText();
           String Sold=jTextField60.getText();
           String sql="delete from CARSALE.X6 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField58.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BMWC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
