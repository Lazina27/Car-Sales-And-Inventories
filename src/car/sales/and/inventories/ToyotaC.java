...
public class ToyotaC extends javax.swing.JFrame {
    ...
    public void showToyotaC(){
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.T86");
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.SUPRA");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.RAV4");
        ResultSet res=stmt.executeQuery(sql);
    ...
    try{
        stmt=conn.createStatement();
        String sql=("select *from CARSALE.AVALON");
        ResultSet res=stmt.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton81, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 580, 120, 40));
        ...
        getContentPane().add(jLabel78, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 540, -1, -1));
        ...
        getContentPane().add(jTextField58, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 530, 170, 40));
        ...
        getContentPane().add(jButton83, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 530, 120, 40));
        ...
        getContentPane().add(jLabel79, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 600, -1, -1));
        ...
        getContentPane().add(jTextField59, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 590, 170, 40));
        ...
        getContentPane().add(jLabel80, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 660, -1, -1));
        getContentPane().add(jTextField60, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 650, 170, 40));
        ...
        getContentPane().add(jButton85, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 590, 120, 40));

        jLabel77.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel77.setForeground(new java.awt.Color(102, 0, 0));
        jLabel77.setText("        Toyota Avalon");
        jLabel77.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 0, 0), 3));
        getContentPane().add(jLabel77, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 460, 220, 40));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 30, -1, 50));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 380, 170));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 270, 380, 170));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 710, 380, 180));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 710, 380, 180));
    ...
    private void jButton71ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton71ActionPerformed
        try{
           ...
           String sql="insert into CARSALE.T86(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
    ...
    private void jButton73ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton73ActionPerformed
        try{
           ...
           String Stock=jTextField50.getText();
           String Sold=jTextField51.getText();
           String sql="delete from CARSALE.T86 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
    ...
    private void jButton75ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton75ActionPerformed
         try{
          ...
          String Purchased=jTextField52.getText();
           ...
           String sql="insert into CARSALE.SUPRA(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton77ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton77ActionPerformed
        try{
          ...
          String Purchased=jTextField52.getText();
           String Stock=jTextField53.getText();
           String Sold=jTextField54.getText();
           String sql="delete from CARSALE.SUPRA where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField52.setText("");
    ...
    private void jButton79ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton79ActionPerformed
        try{
          ...
          String Purchased=jTextField55.getText();
           ...
           String sql="insert into CARSALE.RAV4(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton81ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton81ActionPerformed
         try{
          ...
          String Purchased=jTextField55.getText();
           String Stock=jTextField56.getText();
           String Sold=jTextField57.getText();
           String sql="delete from CARSALE.RAV4 where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField55.setText("");
    ...
    private void jButton83ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton83ActionPerformed
        try{
          ...
          String Purchased=jTextField58.getText();
           ...
           String sql="insert into CARSALE.AVALON(PURCHASED,STOCK,SOLD) VALUES('"+Purchased+"','"+Stock+"','"+Sold+"') ";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully added" );
    ...
    private void jButton85ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton85ActionPerformed
         ...
         String Purchased=jTextField58.getText();
           String Stock=jTextField59.getText();
           String Sold=jTextField60.getText();
           String sql="delete from CARSALE.AVALON where STOCK='"+Stock+"'";
            conn = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521","CARSALE","123");
            stmt.executeUpdate(sql);
             JOptionPane.showMessageDialog(null, "Data is successfully deleted" );
        jTextField58.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ToyotaC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
